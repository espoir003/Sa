...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-fr" lang="en-fr">

<head>
    <meta charset="utf-8">
    <title>Compagnie Sucrière - S.A | Home</title>
        ...
        <div id="pagee" class="clearfix">
            ...
            <main id="main">
                        ...
                        <div class="swiper-wrapper">
                            <div class="slider-home1 relative overflow-hidden swiper-slide">
                                <div class="silider-image">
                                    <img src="./assets/images/slide/03.jpeg" alt="Image" class="image-slide">
                                ...
                                <div class="slider-content">
                                    <div class="tf-container">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <span class="sub-title text-main font-yes fs-28-46 fadeInDown wow">Compagnie Sucrière</span>
                                                <h1 class="title-slide text-white mb-32 fadeInDown wow"> Bienvenue à la
                                                    Compagnie Sucrière de
                                                    <span class="animationtext clip text-main">
                                                        <span class="cd-words-wrapper">
                                                            <span class="item-text is-visible">Kwilu-ngongo</span>
                                                            <span class="item-text is-hidden">Kongo-Central</span>
                                                        </span>
                                                    </span>
                                                </h1>
                                                <p class="des text-white mb-45 fadeInDown wow">Un sucre naturel, cultivé avec soin au cœur du Kongo Central. Découvrez l’excellence sucrière à travers des générations d’expertise.</p>
                                                <div class="btn-group">
                                                    <a href="#" class="btn-main fadeInDown wow">
                                                        <p class="btn-main-text">Explorez notre histoire</p>
                                                        <p class="iconer">
                                                            <i class="icon-arrow-right"></i>
                                                        </p>
                                                    </a>
                                                    <a href="#" class="btn-w-wa fadeInDown wow">Nos engagements <i class="icon-Group-13"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="slider-home1 relative overflow-hidden swiper-slide">
                                <div class="silider-image">
                                    <img src="assets/images/slide/01.jpg" alt="Image" class="image-slide">
                                    <img src="assets/images/slide/mask-slide.png" alt="Image" class="mask-slide">
                                    <img src="assets/images/slide/mask-fly.png" alt="Image" class="mask-flane">
                                    <div class="booking-title tf-anime-rorate">
                                        <p class="booking">Sucrière</p>
                                ...
                                <div class="slider-content">
                                        ...
                                        <div class="tf-container">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <span class="sub-title text-main font-yes fs-28-46 fadeInDown wow">Sucre Raffiné</span>
                                                    <h1 class="title-slide text-white mb-32 fadeInDown wow"> Découvrez la Sucrerie de
                                                        <span class="animationtext clip text-main">
                                                            <span class="cd-words-wrapper">
                                                                <span class="item-text is-visible">Kwilu-ngongo</span>
                                                                <span class="item-text is-hidden">Kongo-Central</span>
                                                    ...
                                                    <p class="des text-white mb-45 fadeInDown wow">Un sucre de qualité supérieure, issu d'une production durable. Rejoignez-nous pour un avenir plus doux et plus responsable.</p>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn-main fadeInDown wow">
                                                            <p class="btn-main-text">Voir nos produits</p>
                                                            <p class="iconer">
                                                                <i class="icon-arrow-right"></i>
                                                            </p>
                                                        </a>
                                                        <a href="#" class="btn-w-wa fadeInDown wow">Notre mission <i class="icon-Group-13"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="slider-home1 relative overflow-hidden swiper-slide">
                                <div class="silider-image">
                                    <img src="./assets/images/slide/02.jpeg" alt="Image" class="image-slide">
                                    <img src="./assets/images/slide/mask-slide.png" alt="Image" class="mask-slide">
                                    <img src="./assets/images/slide/mask-fly.png" alt="Image" class="mask-flane">
                                    <div class="booking-title tf-anime-rorate">
                                        <p class="booking">Sucrière</p>
                                ...
                                <div class="tf-container">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <span class="sub-title text-main font-yes fs-28-46 fadeInDown wow">Sucrerie Centenaire</span>
                                            <h1 class="title-slide text-white mb-32 fadeInDown wow"> La Tradition Sucrière de
                                                <span class="animationtext clip text-main">
                                                    <span class="cd-words-wrapper">
                                                        <span class="item-text is-visible">Kwilu-ngongo</span>
                                                        <span class="item-text is-hidden">Kongo-Central</span>
                                            ...
                                            <p class="des text-white mb-45 fadeInDown wow">Depuis 1925, la Compagnie Sucrière de Kwilu-Ngongo s'engage à offrir un sucre raffiné et respectueux de l'environnement, avec des normes de qualité inégalées.</p>
                                            <div class="btn-group">
                                                <a href="#" class="btn-main fadeInDown wow">
                                                    <p class="btn-main-text">En savoir plus</p>
                                                    <p class="iconer">
                                                        <i class="icon-arrow-right"></i>
                                                    </p>
                                                </a>
                                                <a href="#" class="btn-w-wa fadeInDown wow">Nos valeurs <i class="icon-Group-13"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group flex">
                                             <i class="icon-hiking-1-1 "></i>
                                                <div class="search-bar-group">
                                                    <label>Sucre Blanc Raffiné</label>
                                                    <input type="text" value="1 Sac = 100$" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group flex">
                                             <i class="icon-hiking-1-1 "></i>
                                                <div class="search-bar-group">
                                                    <label>Sucre Roux</label>
                                                    <input type="text" value="1 Sac = 10$" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group flex">
                                             <i class="icon-hiking-1-1 "></i>
                                                <div class="search-bar-group">
                                                    ...
                                                    <input type="text" value="1Kg = 50$" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group flex">
                                             <i class="icon-hiking-1-1 "></i>
                                                <div class="search-bar-group">
                                                    <label>Casonade</label>
                                                    <input type="text" value="1 Sac = 5$" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group flex">
                                             <i class="icon-hiking-1-1 "></i>
                    ...
                    <div class="tf-container">
                        <div class="row pt-35">
                            <div class="col-lg-12 flex">
                                ...
                                <p class="client fadeInUp wow">2 500 clients ont acheté des produits de la Compagnie Sucrière au cours des 24 dernières heures.</p>
                            </div>
                        </div>
                        <div class="row pt-115">
                            <div class="col-lg-6">
                                <div class="travel-video relative">
                                    <img src="./assets/img/sache.jpg" alt="Image" class="image-video">
                                    <div class="video-wrap">
                                        <a href="https://www.youtube.com/watch?v=WLZ2hbutWNY"
                            ...
                            <div class="col-lg-6">
                                <div class="inner-content-about">
                                    <span class="sub-title-heading text-main mb-15 fadeInUp wow">Explorez l'univers du sucre</span>
                                    <h2 class="title-heading mb-18 fadeInUp wow">Votre guide de confiance pour les <span
                                    class="text-gray font-yes">Produits sucriers</span></h2>
                                    <p class="des-heading fadeInUp wow" style="text-align: justify;">
                                    Le groupe produit des sucres roux, blonds, blancs et raffinés à partir de cannes et de betteraves, commercialisés dans l'industrie et la grande distribution. Il produit également des caramels et des spécialités, de l’alcool, de la mélasse, des pulpes de betteraves ainsi que d’autres produits destinés à l’alimentation animale. Le groupe vend de l'énergie renouvelable sous forme d'électricité.
                                    </p>
                                   
                                    <div class="flex-three btn-wrap-about mb-30 fadeInUp wow">
                                        <a href="login" class="btn-main">
                                            <p class="btn-main-text">Commander</p>
                                            <p class="iconer">
                                                <i class="icon-arrow-right"></i>
                                            </p>
                ...
                <section class="relative tf-widget-activities pd-main overflow-hidden">
                    <img src="./assets/img/1696800207640.jpeg" alt="image" class="mask-top">
                    <img src="./assets/img/img.jpg" alt="image" class="mask-bottom">
                    <div class="tf-container">
                        <div class="row z-index3 relative">
                            <div class="col-lg-12 mb-60">
                                <div class="clip-text">PRODUITS</div>
                            </div>
                            <div class="col-lg-12">
                                <ul class="nav nav-tabs-activities justify-content-center" id="myTablist"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                            ...
                                            <span>Sucre blanc de betteraves</span>
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-content mt-44" id="myTabContents">
                                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                        ...
                                        <div class="tabs-activities-content flex">
                                            <div class="activities-image">
                                                <img src="./assets/img/sache.jpg" alt="Image">
                                            </div>
                                            <div class="activities-content relative">
                                                <span class="sub-title text-white">Bienvenue à la Compagnie Sucrière Kwilu-Ngongo</span>
                                                <h3 class="title-activitis text-white mb-60">Découvrez la douceur du sucre blanc</h3>
                                                <div class="flex-three mb-30">
                                                    <div class="flex-three text-white icon-list-wrap">
                                                        <div class="icon">
                                                            <i class="icon-Page-1"></i>
                                                        </div>
                                                        <span class="icon-lists">Un goût pur et authentique</span>
                                                    </div>
                                                    <div class="flex-three text-white icon-list-wrap">
                                                        <div class="icon">
                                                            <i class="icon-rubber-ring-1"></i>
                                                        </div>
                                                        <span class="icon-lists">Produit de qualité supérieure</span>
                                                    </div>
                                                </div>
                                                <div class="flex-three btn-wrap-activitis">
                                                    ...
                                                    <a href="#" class="text-white get-start">Commandez dès aujourd'hui</a>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel"
                                        ...
                                        <div class="tabs-activities-content flex">
                                            ...
                                            <div class="activities-content relative">
                                                <span class="sub-title text-white">Bienvenue à la Compagnie Sucrière Kwilu-Ngongo</span>
                                                <h3 class="title-activitis text-white mb-60">Savourez l'authenticité du sucre de canne</h3>
                                                <div class="flex-three mb-30">
                                                    <div class="flex-three text-white icon-list-wrap">
                                                        <div class="icon">
                                                            <i class="icon-Page-1"></i>
                                                        </div>
                                                        <span class="icon-lists">Goût naturel et pur</span>
                                                    </div>
                                                    <div class="flex-three text-white icon-list-wrap">
                                                        <div class="icon">
                                                            <i class="icon-rubber-ring-1"></i>
                                                        </div>
                                                        <span class="icon-lists">Produit respectueux de l'environnement</span>
                                                    </div>
                                                </div>
                                                <div class="flex-three btn-wrap-activitis">
                                                    <a href="#" class="icon-activitis flex-five">
                                                    ...
                                                    <a href="#" class="text-white get-start">Découvrez-le dès aujourd'hui</a>
                                                </div>
                                                <img src="./assets/images/page/mask-tap.png" alt="image" class="mask-tab">
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel"
                                        ...
                                        <div class="tabs-activities-content flex">
                                            ...
                                            <div class="activities-content relative">
                                            <span class="sub-title text-white">Bienvenue à la Compagnie Sucrière Kwilu-Ngongo</span>
                                            <h3 class="title-activitis text-white mb-60">Découvrez la pureté du sucre raffiné</h3>
                                            <div class="flex-three mb-30">
                                                <div class="flex-three text-white icon-list-wrap">
                                                    <div class="icon">
                                                        <i class="icon-Page-1"></i>
                                                    </div>
                                                    <span class="icon-lists">Qualité supérieure et pureté absolue</span>
                                                </div>
                                                <div class="flex-three text-white icon-list-wrap">
                                                    <div class="icon">
                                                        <i class="icon-rubber-ring-1"></i>
                                                    </div>
                                                    <span class="icon-lists">Idéal pour toutes vos recettes</span>
                                                </div>
                                            </div>
                                            <div class="flex-three btn-wrap-activitis">
                                                <a href="#" class="icon-activitis flex-five">
                                    ...
                                    <div class="tab-pane fade" id="ab-tab-pane" role="tabpanel" aria-labelledby="ab-tab"
                                        ...
                                        <div class="tabs-activities-content flex">
                                            ...
                                            <div class="activities-content relative">
                                            <span class="sub-title text-white">Découvrez notre gamme de produits</span>
                                            <h3 class="title-activitis text-white mb-60">Des solutions innovantes pour l'industrie et l'alimentation</h3>
                                            <div class="flex-three mb-30">
                                                <div class="flex-three text-white icon-list-wrap">
                                                    <div class="icon">
                                                        <i class="icon-Page-1"></i>
                                                    </div>
                                                    <span class="icon-lists">Produits de haute qualité pour divers secteurs</span>
                                                </div>
                                                <div class="flex-three text-white icon-list-wrap">
                                                    <div class="icon">
                                                        <i class="icon-rubber-ring-1"></i>
                                                    </div>
                                                    <span class="icon-lists">Satisfaction garantie pour vos besoins industriels</span>
                                                </div>
                                            </div>
                                            <div class="flex-three btn-wrap-activitis">
                                                <a href="#" class="icon-activitis flex-five">
                                                ...
                                                <a href="#" class="text-white get-start">En savoir plus</a>
                                            </div>
                                            <img src="./assets/images/page/mask-tap.png" alt="image" class="mask-tab">
                                        </div>
                                ...
                                <div class="swiper brand-logo overflow-hidden">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="./assets/img/icone-windows-gris.png" alt="">
                                        </div>
                                      
                                        <div class="swiper-slide">
                                            <img src="./assets/img/mac.webp" alt="">
                                        </div>
                                        <div class="swiper-slide">
                        ...
                        <div class="row z-index3 relative">
                            ...
                            <div class="col-lg-5">
                                <div class="image-banner-contact">
                                    <img src="./assets/img/1696800200575.jpeg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
